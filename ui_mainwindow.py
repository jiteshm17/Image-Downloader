...
"}*/")
        ...
        self.radioButton_bing.setChecked(True)
        ...
        self.spinBox_max_number.setProperty("value", 10)
        ...
        # self.radioButton_bing.toggled['bool'].connect(self.checkBox_safe_mode.setEnabled)
